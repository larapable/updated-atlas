    ...
    useEffect(() => {
        ...
        const fetchDataAndCategorize = async (apiEndpoint: string) => {
            try {
                ...
                const categorizedSentences: GeneratedSentence[] = generatedSentences.reduce((acc, sentence) => {
        ...
        const fetchAllData = async (department_id: number) => {
            ...
            if (department_id) {
                ...
                console.error(
                    'Department ID not found in user data. Cannot save data.'
                );
            }
        };
        ...
        const fetchExistingStrategies = async (department_id: number) => {
            try {
                ...
                const strategies = {
                    financial: data.financial.map((item: any) => ({ id: 1, value: item.input })),
                    stakeholder: data.stakeholder.map((item: any) => ({ id: 2, value: item.input })),
                    internalProcess: data.internalProcess.map((item: any) => ({ id: 3, value: item.input })),
                    learningGrowth: data.learningGrowth.map((item: any) => ({ id: 4, value: item.input })),
                };
        ...
        const checkGeneratedAiStrats = async () => {
            try {
                ...
                <div className="flex-1 flex flex-col mt-8 ml-80">
                    ...
                    <div className="mt-8 grid grid-cols-3">
                        <div className="col-span-2">
                            ...
                            Strategy mapping empowers organizations to translate their vision into actionable strategies, align resources, and drive performance across all aspects of the business.  Navigate complexity, capitalize on opportunities, and achieve sustainable growth in today&apos;s dynamic business landscape.
                            </div>
                            {/* perspectives toggle */}
                            ...
                            {/* main container */}
                            <div className="shadow-[0rem_0.3rem_0.3rem_0rem_rgba(0,0,0,0.25)] border border-gray-300 bg-[#FFFFFF] relative mr-10 flex flex-col pt-4 pr-5 pl-5 w-[100%] h-auto mb-10 rounded-lg">
                                {selectedPerspective === 'financial' && (
                                    <div className="flex flex-col align-middle items-center justify-center relative w-[100%]">
                                            ...
                                            <div className="fixed inset-0 flex items-center justify-center">
                                                ...
                                                <div className="bg-white p-8 rounded-lg z-10 h-[29rem] w-[70rem]">
                                                    <div className="flex flex-row">
                                                        ...
                                                        <button onClick={closeFModal} className="ml-[51rem] mt-[-4rem] text-gray-500 hover:text-gray-700">
                                                            <svg
                                                    ...
                                                    <input type="text" value={newFTargetCode} onChange={(e) => setNewFTargetCode(e.target.value)} className="border border-gray-300 rounded px-3 py-2 mb-4" />
                                                    <div className="flex flex-col">
                                                        <span className="mr-3 mb-2 break-words font-regular text-md text-[#000000]">
                                                            Strategy
                                                            <span className='text-[#DD1414]'>*</span>
                                                        </span>
                                                        <textarea value={newFStrategy} onChange={(e) => setNewFStrategy(e.target.value)} className="border border-gray-300 pl-2 pr-2 rounded-lg w-[66rem] h-[10rem]" />
                                                    </div>
                                                    <div className="flex flex-row justify-center mt-2 gap-10">
                                                        <button onClick={closeFModal} className="bg-[#8A252C] text-[#ffffff] font-semibold hover:bg-[#a8444b] hover:text-[#ffffff] px-4 py-2 mt-4 rounded-lg w-40">
                                                            Cancel
                                                        </button>
                                                        <button onClick={handleFSave} className="bg-[#eec160] text-[#8A252C] font-semibold hover:bg-[#f8d384] hover:text-[#8A252C] px-4 py-2 mt-4 rounded-lg w-40">
                                                            Save
                                                        </button>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="bg-[#ffffff] mt-5 w-[100%] h-auto flex flex-col pt-4 pr-3 pb-6 box-sizing-border rounded-lg mb-10 border border-yellow-500 overflow-y-auto overflow-x-hidden">
                                            {strategies.financial.map((strategy, index) => (
                                                <div key={strategy.id} className="bg-[#ffffff] relative mr-8 flex flex-row pt-4 pr-12 pb-4 w-[70rem] h-auto box-sizing-border">
                                                    <div className="mt-[-0.6rem] pr-3 pl-3 w-[100%] h-10">
                                                        {strategy.value}
                                                    </div>
                                                </div>
                                            ))}
                                            {savedFStrategies.map((strategy) => (
                                                <div key={strategy.id} className="mt-[-0.6rem] pr-3 pl-3 w-[100%] h-10">
                                                    {strategy}
                                                </div>
                                            ))}
                                        </div>
                                    ...
                                    <div className="flex flex-col align-middle items-center justify-center relative w-[100%]">
                                        ...
                                        {isLGModalOpen && (
                                            <div className="fixed inset-0 flex items-center justify-center">
                                                ...
                                                <div className="bg-white p-8 rounded-lg z-10 h-[29rem] w-[70rem]">
                                                    <div className="flex flex-row">
                                                        <h2 className="text-2xl mb-5 font-semibold">Learning & Growth  Strategy</h2>
                                                        <button onClick={closeLGModal} className="ml-[44rem] mt-[-4rem] text-gray-500 hover:text-gray-700">
                                                            <svg
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                fill="none"
                                                                viewBox="0 0 24 24"
                                                    ...
                                                    <input type="text" value={newLGTargetCode} onChange={(e) => setNewLGTargetCode(e.target.value)} className="border border-gray-300 rounded px-3 py-2 mb-4" />
                                                    <div className="flex flex-col">
                                                        <span className="mr-3 mb-2 break-words font-regular text-md text-[#000000]">
                                                            Strategy
                                                            <span className='text-[#DD1414]'>*</span>
                                                        </span>
                                                        <textarea value={newLGStrategy} onChange={(e) => setNewLGStrategy(e.target.value)} className="border border-gray-300 pl-2 pr-2 rounded-lg w-[66rem] h-[10rem]" />
                                                    </div>
                                                    <div className="flex flex-row justify-center mt-2 gap-10">
                                                        <button onClick={closeLGModal} className="bg-[#8A252C] text-[#ffffff] font-semibold hover:bg-[#a8444b] hover:text-[#ffffff] px-4 py-2 mt-4 rounded-lg w-40">
                                                            Cancel
                                                        </button>
                                                        <button onClick={handleLGSave} className="bg-[#eec160] text-[#8A252C] font-semibold hover:bg-[#f8d384] hover:text-[#8A252C] px-4 py-2 mt-4 rounded-lg w-40">
                                                            Save
                                                        </button>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="bg-[#ffffff] mt-5 w-[100%] h-auto flex flex-col pt-4 pr-3 pb-6 box-sizing-border rounded-lg mb-10 border border-yellow-500 overflow-y-auto overflow-x-hidden">
                                            {strategies.learningGrowth.map((strategy, index) => (
                                                <div key={strategy.id} className="bg-[#ffffff] relative mr-8 flex flex-row pt-4 pr-12 pb-4 w-[70rem] h-14 box-sizing-border">
                                                    <div className="mt-[-0.6rem] pr-3 pl-3 w-[100%] h-10">
                                                        {strategy.value}
                                                    </div>
                                                </div>
                                            ))}
                                            {savedLGStrategies.map((strategy, index) => (
                                                <div className="mt-[-0.6rem] pr-3 pl-3 w-[100%] h-10">
                                                    {strategy}
                                                </div>
                                            ))}
                                    ...
                                    <div className="flex flex-col align-middle items-center justify-center relative w-[100%]">
                                        ...
                                        {isIPModalOpen && (
                                            <div className="fixed inset-0 flex items-center justify-center">
                                                ...
                                                <div className="bg-white p-8 rounded-lg z-10 h-[29rem] w-[70rem]">
                                                    <div className="flex flex-row">
                                                        <h2 className="text-2xl mb-5 font-semibold">Internal Process  Strategy</h2>
                                                        <button onClick={closeIPModal} className="ml-[46rem] mt-[-4rem] text-gray-500 hover:text-gray-700">
                                                            <svg
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                fill="none"
                                                                viewBox="0 0 24 24"
                                                    ...
                                                    <input type="text" value={newIPTargetCode} onChange={(e) => setNewIPTargetCode(e.target.value)} className="border border-gray-300 rounded px-3 py-2 mb-4" />
                                                    <div className="flex flex-col">
                                                        <span className="mr-3 mb-2 break-words font-regular text-md text-[#000000]">
                                                            Strategy
                                                            <span className='text-[#DD1414]'>*</span>
                                                        </span>
                                                        <textarea value={newIPStrategy} onChange={(e) => setNewIPStrategy(e.target.value)} className="border border-gray-300 pl-2 pr-2 rounded-lg w-[66rem] h-[10rem]" />
                                                    </div>
                                                    <div className="flex flex-row justify-center mt-2 gap-10">
                                                        <button onClick={closeIPModal} className="bg-[#8A252C] text-[#ffffff] font-semibold hover:bg-[#a8444b] hover:text-[#ffffff] px-4 py-2 mt-4 rounded-lg w-40">
                                                            Cancel
                                                        </button>
                                                        <button onClick={handleIPSave} className="bg-[#eec160] text-[#8A252C] font-semibold hover:bg-[#f8d384] hover:text-[#8A252C] px-4 py-2 mt-4 rounded-lg w-40">
                                                            Save
                                                        </button>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="bg-[#ffffff] mt-5 w-[100%] h-auto flex flex-col pt-4 pr-3 pb-6 box-sizing-border rounded-lg mb-10 border border-yellow-500 overflow-y-auto overflow-x-hidden">
                                            {strategies.internalProcess.map((strategy, index) => (
                                                <div key={strategy.id} className="bg-[#ffffff] relative mr-8 flex flex-row pt-4 pr-12 pb-4 w-[70rem] h-14 box-sizing-border">
                                                    <div className="mt-[-0.6rem] pr-3 pl-3 w-[100%] h-10">
                                                        {strategy.value}
                                                    </div>
                                            ...
                                            {savedIPStrategies.map((strategy, index) => (
                                                <div className="mt-[-0.6rem] pr-3 pl-3 w-[100%] h-10">
                                                    {strategy}
                                                </div>
                                            ))}
                                ...
                                {selectedPerspective === 'stakeholder' && (
                                    ...
                                    <div className="flex flex-col align-middle items-center justify-center relative w-[100%]">
                                            ...
                                            <div className="fixed inset-0 flex items-center justify-center">
                                                ...
                                                <div className="bg-white p-8 rounded-lg z-10 h-[29rem] w-[70rem]">
                                                    <div className="flex flex-row">
                                                        ...
                                                        <button onClick={closeSModal} className="ml-[49rem] mt-[-4rem] text-gray-500 hover:text-gray-700">
                                                            <svg
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                fill="none"
                                                                viewBox="0 0 24 24"
                                                    ...
                                                    <input type="text" value={newSTargetCode} onChange={(e) => setNewSTargetCode(e.target.value)} className="border border-gray-300 rounded px-3 py-2 mb-4" />
                                                    <div className="flex flex-col">
                                                        <span className="mr-3 mb-2 break-words font-regular text-md text-[#000000]">
                                                            Strategy
                                                            <span className='text-[#DD1414]'>*</span>
                                                        </span>
                                                        <textarea value={newSStrategy} onChange={(e) => setNewSStrategy(e.target.value)} className="border border-gray-300 pl-2 pr-2 rounded-lg w-[66rem] h-[10rem]" />
                                                    </div>
                                                    <div className="flex flex-row justify-center mt-2 gap-10">
                                                        <button onClick={closeSModal} className="bg-[#8A252C] text-[#ffffff] font-semibold hover:bg-[#a8444b] hover:text-[#ffffff] px-4 py-2 mt-4 rounded-lg w-40">
                                                            Cancel
                                                        </button>
                                                        <button onClick={handleSSave} className="bg-[#eec160] text-[#8A252C] font-semibold hover:bg-[#f8d384] hover:text-[#8A252C] px-4 py-2 mt-4 rounded-lg w-40">
                                                            Save
                                                        </button>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="bg-[#ffffff] mt-5 w-[100%] h-auto flex flex-col pt-4 pr-3 pb-6 box-sizing-border rounded-lg mb-10 border border-yellow-500 overflow-y-auto overflow-x-hidden">
                                            {strategies.stakeholder.map((strategy, index) => (
                                                <div key={strategy.id} className="bg-[#ffffff] relative mr-8 flex flex-row pt-4 pr-12 pb-4 w-[70rem] h-14 box-sizing-border">
                                                    <div className="mt-[-0.6rem] pr-3 pl-3 w-[100%] h-10">
                                                        {strategy.value}
                                                    </div>
                                            ...
                                            {savedSStrategies.map((strategy, index) => (
                                                <div className="mt-[-0.6rem] pr-3 pl-3 w-[100%] h-10">
                                                    {strategy}
                                                </div>
                                            ))}
                        ...
                        <div className="col-span-1 flex justify-end hidden lg:flex">
                            ...
                            <div className="flex flex-col gap-[1.5rem] mt-[-6rem] mr-2">
                                <div className="bg-[#ffffff] rounded-lg p-4 border border-gray-300 h-80 w-[30rem] shadow-[0rem_0.3rem_0.3rem_0rem_rgba(0,0,0,0.25)] overflow-hidden">
                                    <div className="rounded-t-lg bg-[#8A252C] p-2 flex items-center justify-between">
                                        ...
                                        <div className="relative">
                                            <button className="px-2 py-1 text-[#ffffff] rounded hover:bg-[#FAD655] text-xl font-bold" onClick={() => handleMoreClick('vision')}>
                                            ...
                                            {showVisionDropdown && (
                                                <div className={`absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg z-10`}>
                                                    <div className="py-1">
                                                        <button className="block px-4 py-2 text-gray-800 hover:bg-gray-100 hover:text-red-500 w-full text-left" onClick={() => handleAddClick('vision', setVisionButtonLabel, setTextareaDisabled)}>{buttonVisionLabel}</button>
                                                        <button className="block px-4 py-2 text-gray-800 hover:bg-gray-100 hover:text-red-500 w-full text-left" onClick={() => handleVisionDeleteClick('vision')}>Delete</button>
                                                    </div>
                                                </div>
                                            )}
                                        </div>
                                    ...
                                    {showVisionCard && !visionSaved && (
                                        <div className="bg-white rounded-lg p-1 h-60 w-[28rem]">
                                            ...
                                            <button onClick={() => handleVisionSaveClick(setVisionSaved, setVisionButtonLabel, setTextareaDisabled)} className="flex mt-[-17.89rem] ml-[20rem] px-2 py-1 bg-white text-[#8A252C] rounded hover:bg-[#FAD655] text-xl font-medium">Save</button>
                                        </div>
                                    )}
                                ...
                                <div className="bg-[#ffffff] rounded-lg p-4 border border-gray-300 h-80 w-[30rem] shadow-[0rem_0.3rem_0.3rem_0rem_rgba(0,0,0,0.25)] overflow-hidden">
                                    <div className="rounded-t-lg bg-[#8A252C] p-2 flex items-center justify-between">
                                        ...
                                        <div className="relative">
                                            <button className="px-2 py-1 text-[#ffffff] rounded hover:bg-[#FAD655] text-xl font-bold" onClick={() => handleMoreClick('values')}>
                                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 12h16M4 18h16" />
                                                </svg>
                                            </button>
                                            {showValuesDropdown && (
                                                <div className={`absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg z-10`}>
                                                    <div className="py-1">
                                                        <button className="block px-4 py-2 text-gray-800 hover:bg-gray-100 hover:text-red-500 w-full text-left" onClick={() => handleAddClick('values', setValuesButtonLabel, setTextareaDisabled)}>{buttonValuesLabel}</button>
                                                        <button className="block px-4 py-2 text-gray-800 hover:bg-gray-100 hover:text-red-500 w-full text-left" onClick={() => handleValuesDeleteClick('values')}>Delete</button>
                                                    </div>
                                                </div>
                                            )}
                                        </div>
                                    ...
                                    {showValuesCard && !valuesSaved && (
                                        <div className="bg-white rounded-lg p-1 h-60 w-[28rem]">
                                            ...
                                            <button onClick={() => handleValuesSaveClick(setValuesSaved, setValuesButtonLabel, setTextareaDisabled)} className="flex mt-[-17.89rem] ml-[20rem] px-2 py-1 bg-white text-[#8A252C] rounded hover:bg-[#FAD655] text-xl font-medium">Save</button>
                                        </div>
                                    )}
                                ...
                                <div className="bg-[#ffffff] rounded-lg p-4 border border-gray-300 h-80 w-[30rem] shadow-[0rem_0.3rem_0.3rem_0rem_rgba(0,0,0,0.25)] overflow-hidden">
                                    <div className="rounded-t-lg bg-[#8A252C] p-2 flex items-center justify-between">
                                        ...
                                        <div className="relative">
                                            <button className="px-2 py-1 text-[#ffffff] rounded hover:bg-[#FAD655] text-xl font-bold" onClick={() => handleMoreClick('mission')}>
                                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 12h16M4 18h16" />
                                                </svg>
                                            </button>
                                            {showMissionDropdown && (
                                                <div className={`absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg z-10`}>
                                                    <div className="py-1">
                                                        <button className="block px-4 py-2 text-gray-800 hover:bg-gray-100 hover:text-red-500 w-full text-left" onClick={() => handleAddClick('mission', setMissionButtonLabel, setTextareaDisabled)}>{buttonMissionLabel}</button>
                                                        <button className="block px-4 py-2 text-gray-800 hover:bg-gray-100 hover:text-red-500 w-full text-left" onClick={() => handleMissionDeleteClick('mission')}>Delete</button>
                                                    </div>
                                                </div>
                                            )}
                                        </div>
                                    ...
                                    {showMissionCard && !missionSaved && (
                                        <div className="bg-white rounded-lg p-1 h-60 w-[28rem]">
                                            ...
                                            <button onClick={() => handleMissionSaveClick(setMissionSaved, setMissionButtonLabel, setTextareaDisabled)} className="flex mt-[-17.89rem] ml-[20rem] px-2 py-1 bg-white text-[#8A252C] rounded hover:bg-[#FAD655] text-xl font-medium">Save</button>
                                        </div>
                                    )}
